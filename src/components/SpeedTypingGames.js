...
import './SpeedTypingGames.css';
import TypingArea from './TypingArea';

const SpeedTypingGames = () => {
    const paragraphs = [
    ...
    return (<div className="container" >
        ...
        <TypingArea typingText={typingText} inpFieldValue={inpFieldValue} timeLeft={timeLeft} mistakes={mistakes} WPM={WPM} CPM={CPM} initTyping={initTyping} handleKeyDown={handleKeyDown} resetGame={resetGame} />
        </div>
        );
};

        export default SpeedTypingGames;